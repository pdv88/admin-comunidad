                    ...
                    <ModalPortal>
                        <div className="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                                <div className="fixed inset-0 bg-gray-500 bg-opacity-75 backdrop-blur-sm transition-opacity" aria-hidden="true" onClick={() => setShowCreateForm(false)}></div>
                                ...
                                <div className="inline-block align-bottom glass-card text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                    <div className="px-6 py-6 border-b border-gray-200/50 dark:border-white/10 flex justify-between items-center bg-white/40 dark:bg-black/40 backdrop-blur-md">
                                        <h3 className="text-lg leading-6 font-bold text-gray-800 dark:text-white" id="modal-title">
                                            {t('campaigns.create_title', 'Create New Extraordinary Fee')}
                                        </h3>
                                        <button onClick={() => setShowCreateForm(false)} className="text-gray-400 hover:text-gray-500 text-2xl">&times;</button>
                                    </div>
                                    <div>
                                        <form onSubmit={handleCreate}>
                                            <div className="p-6 space-y-4">
                                                ...
                                                <div className="pt-2 border-t border-gray-100 dark:border-white/5 pt-4">
                                                    ...
                                                    {isMandatory && (
                                                        <div className="animate-fade-in mt-3 bg-white/60 dark:bg-white/5 p-4 rounded-xl border border-white/40 dark:border-white/10 backdrop-blur-md">
                                                            <h4 className="text-xs font-bold text-gray-800 dark:text-white uppercase tracking-wider mb-3 flex items-center gap-2">
                                                            ...
                                                            <div className="grid grid-cols-2 gap-4 mb-3">
                                                                <div className="bg-white/60 dark:bg-black/20 p-2 rounded-lg border border-white/40 dark:border-white/5 backdrop-blur-sm">
                                                            ...
                                                            <button
                                                                ...
                                                                className="text-xs text-gray-600 hover:text-gray-800 dark:text-gray-400 font-medium flex items-center gap-1 mb-2"
                                                            >
                                                                {showBreakdown ? '▼' : '▶'} {t('campaigns.unit_breakdown', 'View Unit Breakdown')}
                                                            </button>

                                                            {showBreakdown && (
                                                                <div className="bg-white/60 dark:bg-black/20 rounded-lg border border-gray-200/50 dark:border-white/5 max-h-40 overflow-y-auto custom-scrollbar backdrop-blur-sm">
                                                                    <table className="w-full text-xs text-left">
                                                                        <thead className="bg-gray-50/50 dark:bg-white/5 sticky top-0 backdrop-blur-sm">
                                                                            <tr>
                                                                        ...
                                                                        <tbody>
                                                                            {affectedUnits.length > 0 ? affectedUnits.map((u, idx) => (
                                                                                <tr key={`u-${idx}`} className="border-b border-gray-100/50 dark:border-white/5 last:border-0 hover:bg-white/30 dark:hover:bg-white/5">
                                                    ...
                                                    {targetType === 'blocks' && (
                                                        <div className="mt-2">
                                                            ...
                                                            {selectedBlocks.length > 0 && (
                                                                <div className="mt-3 p-3 bg-white/60 dark:bg-white/5 rounded-xl border border-white/40 dark:border-white/10 backdrop-blur-sm">
                                            ...
                                            <div className="px-6 py-4 flex justify-end gap-3 bg-gray-50/50 dark:bg-white/5 border-t border-gray-100 dark:border-white/5">
                                                <Button
                    ...
                    return (
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                            {filteredCampaigns.map(campaign => (
                                <div key={campaign.id} className="glass-card p-5 flex flex-col h-full">
                                    <div className="flex-1">
                                        <div className="mb-2">
                                            <Link to={`/app/campaigns/${campaign.id}`} className="hover:underline">
                                                <h2 className="font-bold text-lg text-gray-800 dark:text-white mb-2">{campaign.name}</h2>
                                            </Link>
                                            <div className="flex items-center gap-2">
                                                <span className={`inline-flex items-center gap-x-1.5 py-0.5 px-2 rounded-md text-[10px] font-bold uppercase tracking-wider ${campaign.is_active ? 'bg-green-100 text-green-800 dark:bg-green-800/30 dark:text-green-500' : 'bg-gray-100 text-gray-800 dark:bg-gray-800/30 dark:text-gray-500'}`}>
                                        ...
                                        <p className="text-sm text-gray-600 dark:text-neutral-400 mb-4 line-clamp-2 min-h-[2.5rem]">
