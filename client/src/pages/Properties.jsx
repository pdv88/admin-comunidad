                                                ...
                                                <form onSubmit={handleCreateBlock}>
                                                    ...
                                                    <div className="flex justify-end gap-3 mt-6">
                                                        ...
                                                        <button type="submit" disabled={isCreatingBlock} className="glass-button w-full sm:w-auto relative flex justify-center items-center disabled:opacity-70 disabled:cursor-not-allowed">
                                                            <span className={isCreatingBlock ? 'invisible' : ''}>{t('properties.add_block_btn')}</span>
                                                            {isCreatingBlock && (
                                            ...
                                            <div className="bg-white/50 dark:bg-black/40 backdrop-blur-md px-6 py-6">
                                                <form onSubmit={handleCreateUnit} className="space-y-4">
                                                    ...
                                                    {(() => {
                                                        ...
                                                        const selectedBlock = blocks.find(b => b.id === newUnit.blockId);
                                    ...
                                    <div key={block.id} className="glass-card overflow-hidden">
                                        <div className="bg-white/30 dark:bg-white/5 px-6 py-3 border-b border-white/20 dark:border-neutral-700/30 flex justify-between items-center">
                                            ...
                                            <div className="flex items-center gap-2">
                                                <button
                                                    onClick={() => {
                                                        setNewUnit(prev => ({ ...prev, blockId: block.id }));
                                                        setUnitModalOpen(true);
                                                    }}
                                                    className="glass-button bg-gradient-to-r from-emerald-500 to-teal-500 border-none shadow-emerald-500/20 text-xs py-1 px-3 flex items-center gap-1"
                                                    title={t('properties.add_unit')}
                                                >
                                                    <span>+</span> {t('properties.add_unit_btn')}
                                                </button>
                                                <span className="text-xs text-gray-500 ml-2">{t('properties.representative')}:</span>
                                                ...
                                                <form onSubmit={handleCreateAmenity} className="space-y-6">
                                                    ...
                                                    <div className="flex justify-end gap-3 pt-4 border-t border-white/20 dark:border-white/10">
                                                        ...
                                                        <button
                                                            ...
                                                            className="glass-button px-8 relative flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed"
                                                        >
                                                            <span className={isSavingAmenity ? 'invisible' : ''}>
                                                                {editingAmenityId ? t('properties.update_amenity', 'Update Amenity') : t('properties.create_amenity', 'Create Amenity')}
                                                            </span>
                                                            {isSavingAmenity && (
                                                                <div className="absolute inset-0 flex items-center justify-center">
