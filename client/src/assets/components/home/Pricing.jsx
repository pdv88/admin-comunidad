        ...
        <table className="w-full">
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-neutral-700">
            ...
            <tr className="border-t border-gray-200 dark:border-neutral-700">
              ...
              <td className="py-5 pe-4">
                {/* <!-- Minus --> */}
                <svg className="flex-shrink-0 ms-auto size-5 text-gray-400 dark:text-neutral-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/></svg>
                {/* <!-- Minus --> */}
      ...
      <table className="w-full h-px">
        ...
        <tbody className="border-t border-gray-200 divide-y divide-gray-200 dark:border-neutral-700 dark:divide-neutral-700">
          ...
          <tr>
            ...
            <td className="py-5 px-6">
              {/* <!-- Minus --> */}
              <svg className="mx-auto flex-shrink-0 size-5 text-gray-400 dark:text-neutral-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/></svg>
              {/* <!-- Minus --> */}
