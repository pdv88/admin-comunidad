    ...
    <>
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto" id="pricing">
        ...
        <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
          <h2 className="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white">Precios</h2>
          <p className="mt-1 text-gray-600 dark:text-neutral-400">Elige el plan que mejor se adapte a las necesidades de tu comunidad.</p>
        </div>
        {/* <!-- End Title --> */}

        {/* <!-- Switch --> */}
        <div className="flex justify-center items-center">
          <label className="min-w-14 text-sm text-gray-500 me-3 dark:text-neutral-400">Mensual</label>
          ...
          <label className="relative min-w-14 text-sm text-gray-500 ms-3 dark:text-neutral-400">
            ...
            <span className="absolute -top-10 start-auto -end-28">
              <span className="flex items-center">
                ...
                <span className="mt-3 inline-block whitespace-nowrap text-[11px] leading-5 font-semibold tracking-wide uppercase bg-blue-600 text-white rounded-full py-1 px-2.5">Ahorra 10%</span>
              </span>
            </span>
          </label>
        </div>
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:items-center">
          ...
          <div className="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-neutral-800">
            <h4 className="font-medium text-lg text-gray-800 dark:text-neutral-200">Básico</h4>
            <span className="mt-7 font-bold text-5xl text-gray-800 dark:text-neutral-200">Gratis</span>
            <p className="mt-2 text-sm text-gray-500 dark:text-neutral-500">Para empezar a organizarse</p>
          ...
          <div className="flex flex-col border-2 border-blue-600 text-center shadow-xl rounded-xl p-8 dark:border-blue-700">
            <p className="mb-3"><span className="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-lg text-xs uppercase font-semibold bg-blue-100 text-blue-800 dark:bg-blue-600 dark:text-white">Más Popular</span></p>
            <h4 className="font-medium text-lg text-gray-800 dark:text-neutral-200">Pro</h4>
            <span className="mt-5 font-bold text-5xl text-gray-800 dark:text-neutral-200">
              <span className="font-bold text-2xl -me-2">€</span>
              {isAnnual ? '29' : '39'}
            </span>
            <p className="mt-2 text-sm text-gray-500 dark:text-neutral-500">Para comunidades activas</p>
          ...
          <div className="flex flex-col border border-gray-200 text-center rounded-xl p-8 dark:border-neutral-800">
            ...
            <p className="mt-2 text-sm text-gray-500 dark:text-neutral-500">Para administradores de fincas</p>
