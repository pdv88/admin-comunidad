        ...
        <div className="relative flex h-screen bg-slate-300 dark:bg-slate-950 overflow-hidden md:gap-2">
            ...
            <div className={`fixed inset-y-4 right-0 z-50 w-64 bg-gradient-to-b from-white/70 to-white/50 backdrop-blur-2xl border border-white/40 dark:from-neutral-900/95 dark:to-neutral-900/80 dark:border-neutral-700/50 shadow-2xl transform transition-transform duration-300 ease-in-out md:left-0 md:ml-4 md:translate-x-0 md:static md:h-[calc(100vh-2rem)] md:my-4 md:rounded-3xl md:inset-auto ${isSidebarOpen ? 'translate-x-0 rounded-l-3xl' : 'translate-x-full'} flex flex-col`}>
                ...
                <nav className="flex-1 px-4 space-y-1 overflow-y-auto customer-scrollbar">
                    ...
                    {hasAnyRole(['super_admin', 'admin', 'president', 'secretary', 'vocal', 'neighbor']) && (
                    ...
                    {hasAnyRole(['super_admin', 'admin', 'president', 'secretary', 'vocal', 'neighbor', 'maintenance']) && (
                    ...
                    {hasAnyRole(['super_admin', 'admin', 'president', 'secretary', 'vocal', 'neighbor', 'security', 'maintenance']) && (
                    ...
                    {hasAnyRole(['super_admin', 'admin', 'president', 'secretary', 'vocal', 'neighbor', 'security']) && (
                    ...
                    {hasAnyRole(['super_admin', 'admin', 'president', 'secretary', 'treasurer', 'vocal']) && (
                        <>
                            ...
                            {/* Community Fees - Accessible to partial admin roles too */}
                            <Link to="/app/maintenance" onClick={closeSidebar} className={`block py-1.5 px-5 rounded-full transition-all duration-200 ${isActive('/app/maintenance')}`}>
                                {t('dashboard_layout.nav.community_fees', 'Community Fees')}
                            </Link>
