                    ...
                    <div className="space-y-6">
                        {campaigns.map(campaign => (
                            <div
                                ...
                                className="bg-white/40 dark:bg-white/5 border border-white/20 dark:border-white/10 rounded-xl p-4 transition-all hover:shadow-lg cursor-pointer hover:bg-white/60 dark:hover:bg-white/10"
                            >
